...
import javax.swing.JOptionPane; //to allow using pop-up dialog boxes
...
public class GemGame 
{
	...
	public static void main(String [] args)
	{
		...
		//get player names with input dialog
		String name1 = JOptionPane.showInputDialog("Enter Player 1's name:");
    	String name2 = JOptionPane.showInputDialog("Enter Player 2's name:");

		//if name is empty or canceled it will revert to default
		...
		while ((player1.size() < MAX_GEMS) && (player2.size() < MAX_GEMS))
		{
			...
			//display the player name variable
			StdDraw.textLeft(0.0, PLAYER1_Y + PLAYER_HALF_HEIGHT - TEXT_HEIGHT, name1 + ": " + score1);
			StdDraw.textLeft(0.0, PLAYER2_Y + PLAYER_HALF_HEIGHT - TEXT_HEIGHT, name2 + ": " + score2);
        ...
        if (score1 == score2)
        	...
        	StdDraw.text(0.5, SCORE_Y, name1 + " wins!");
        else 
        	StdDraw.text(0.5, SCORE_Y, name2 + " wins!");
